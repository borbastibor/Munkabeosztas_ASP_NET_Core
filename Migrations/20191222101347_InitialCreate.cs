    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DolgozoMunka", x => new { x.DolgozoId, x.MunkaId });
                    table.ForeignKey(
                        name: "FK_DolgozoMunka_Dolgozok_DolgozoId",
                        column: x => x.DolgozoId,
                        principalTable: "Dolgozok",
                        principalColumn: "DolgozoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DolgozoMunka_Munkak_MunkaId",
                        column: x => x.MunkaId,
